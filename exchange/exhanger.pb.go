...
func (x *CurrencyRequest) Reset() {
	*x = CurrencyRequest{}
	mi := &file_exhanger_proto_msgTypes[0]
...
func (*CurrencyRequest) Descriptor() ([]byte, []int) {
	return file_exhanger_proto_rawDescGZIP(), []int{0}
}
...
func (x *ExchangeRateResponse) Reset() {
	*x = ExchangeRateResponse{}
	mi := &file_exhanger_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExchangeRateResponse) Descriptor() ([]byte, []int) {
	return file_exhanger_proto_rawDescGZIP(), []int{1}
}
...
func (x *ExchangeRatesResponse) Reset() {
	*x = ExchangeRatesResponse{}
	mi := &file_exhanger_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExchangeRatesResponse) Descriptor() ([]byte, []int) {
	return file_exhanger_proto_rawDescGZIP(), []int{2}
}
...
func (x *Empty) Reset() {
	*x = Empty{}
	mi := &file_exhanger_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Empty) Descriptor() ([]byte, []int) {
	return file_exhanger_proto_rawDescGZIP(), []int{3}
}

var File_exhanger_proto protoreflect.FileDescriptor

var file_exhanger_proto_rawDesc = []byte{
	0x0a, 0x0e, 0x65, 0x78, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4d, 0x61, 0x72, 0x6b, 0x6f, 0x76, 0x6e, 0x69, 0x6b, 0x42,
	0x65, 0x64, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x65, 0x78, 0x63, 0x68, 0x61, 0x6e,
	0x67, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_exhanger_proto_rawDescOnce sync.Once
	file_exhanger_proto_rawDescData = file_exhanger_proto_rawDesc
)

func file_exhanger_proto_rawDescGZIP() []byte {
	file_exhanger_proto_rawDescOnce.Do(func() {
		file_exhanger_proto_rawDescData = protoimpl.X.CompressGZIP(file_exhanger_proto_rawDescData)
	})
	return file_exhanger_proto_rawDescData
}

var file_exhanger_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_exhanger_proto_goTypes = []any{
...
var file_exhanger_proto_depIdxs = []int32{
...
func init() { file_exhanger_proto_init() }
func file_exhanger_proto_init() {
	if File_exhanger_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_exhanger_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_exhanger_proto_goTypes,
		DependencyIndexes: file_exhanger_proto_depIdxs,
		MessageInfos:      file_exhanger_proto_msgTypes,
	}.Build()
	File_exhanger_proto = out.File
	file_exhanger_proto_rawDesc = nil
	file_exhanger_proto_goTypes = nil
	file_exhanger_proto_depIdxs = nil
}
